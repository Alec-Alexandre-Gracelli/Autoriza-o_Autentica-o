...
namespace Autorização_Autenticação
{
    public class PortugueseIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordMismatch() { return new IdentityError { Code = nameof(PasswordMismatch), Description = "Senha atual incorreta." }; }
        ...
        public override IdentityError PasswordRequiresUniqueChars(int uniqueChars) { return new IdentityError { Code = nameof(PasswordRequiresUniqueChars), Description = $"Senhas devem conter {uniqueChars} caracteres únicos e não repetidos." }; }
